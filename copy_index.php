...
<html lang="en">
    <head>
        <title>BHAGINI NIVEDITA Baalika Sadanam</title>
		<meta charset=utf-8>
...
<input type="Password" placeholder="Password" id="pop" name="cm-zvz-zvz" value="" class="addres">
<input type="submit" class="submit" value="Submit" id="newsletterGO3">
</form> 
		</div>
		...
		<div id="ac_content" class="ac_content">
           ...
           <!-- <div id="help">"Help Children in Vettekkara"</div>-->
				...
				<ul>
                       ...
                       <!-- <li>
						<a href="images/MainCourse.jpg">"Help Children in Vettekkara"</a>
        ...
        <p>Economic opportunities in the village are scarce, especially for women. Family plays an important role in the social life of the village. They practice various faiths, including Hinduism, Islam and Christianity. Households consist of parents, married sons and their wives, all unmarried children and the children of sons.</p>
					...
					<li>
						...
						<div class="ac_subitem">
							<span class="ac_close"></span>
							<h2>I Can Help</h2>
							 <h3>Your time, your money or your voice can help the childrens of Baalika Sadanam</h3>
...
<input type="submit" class="donate" id="submit" name="insert_contact" value="Donate to Baalika Sadanam">
</form>

<p>Can't support us financially? We need your help to spread the word about Baalika Sadanam.<br>
     ...
     <p><img src="images/donate-50.png">Student school year sponsorship </p>
					...
					<li>
						...
						<div class="ac_subitem">
                            ...
                            <div id="small">
                            <p style="color:#000000;">Our Email Newsletter</p>
                            <p>If you'd like to receive an electronic version of our newsletter please complete this form.</p>
                                                       
                            <div id="cln_10"></div>
                            
                           <form method="post" action="newsletter.php" onSubmit="return newsletter_validation()">
<input class="input-text" type="text" value="" name="nemail" id="nemail" />
<input type="submit" class="ok" name="Submit" value="Ok">
</form>   
<div id="cln_10"></div>
<p>We only email twice a year and promise never to share your email address with anyone, ever.</p>                                                                               
                            </div>
					...
					<li>
						...
						<div class="ac_subitem">
							<span class="ac_close"></span>
							<h2>Gallery</h2>
							<h3>Meet The Childrens of Baalika Sadanam</h3>
    ...
    <?php 
        ...
        <li>
            <a href="uploads/gallery_image/<?php echo $row['gallery_image'];?>" title="Title">
                <img src="uploads/gallery_thumb/<?php echo $row['gallery_thumb'];?>" alt="" />
            </a>
        </li>
        <?php
		}
                 ...
                 Do not use without permission.</em></p>
                    ...
                    <li>
						...
						<div class="ac_subitem">
							<span class="ac_close"></span>
							<h2>Contact</h2>
							<h3>How To Get In Touch With Baalika Sadanam</h3>
...
<input type="submit" value="Send Message" name="Submit" class="send">
            ...
            <p style="color:#000000;">Baalika Sadanam.</p>
            <p>Vettekkara(po)</p>
            ...
            <p>email@baalikasadanam.org</p>
            </div>
            
            <div class="span_l" style="width:160px;">
            <p style="color:#000000;">Online</p>
            <p style="color:#000000;">Twitter (@baalika sadanam)</p>
		...
		<div class="ac_footer">
			<span><img src="images/copy.png"> 2012 Baalika Sadanam. All rights reserved. | Call Us : 04662 260735.</span>
			<span class="rgt"><a href="#login-box" class="login-window">Webmaster Login</a> | Web Site By<a href="http://www.cyberlegendz.com/"> Cyberlegendz</a></span>
		</div>
		<!-- The JavaScript -->
